        ...
        <section className="bg-gradient-bl !pb-8">
            <div className="container">
                <div className="grid lg:grid-cols-2 gap-4 md:gap-14 lg:gap-6 items-center">
                    <div className="space-y-4 md:space-y-6 lg:pr-20 mb-10 md:mb-0" data-aos="fade-up">
                        <h2 className="d2c_title">Head <span>chef</span></h2>
                        <div className="space-y-4">
                            <p>
                                Meet our culinary maestro, the captain of flavour at our food
                                heaven. Our chef a passionate artisan of the ocean, crafts each
                                dan with precision and creativity
                            </p>
                            <p>
                                With a deep love for food, the chef elevades the dining experience, transforming the finest catches into gastronomic masterpieces. Prepare to embark on a seafood journey curated by the skilled hands of our culinary captain
                            </p>
                        </div>

                        <div className="w-full lg:w-10/12 xl:w-8/12">
                            <p className="text-accent text-xl-1 font-medium capitalize">by_</p>
                            <h4 className="text-accent text-end text-5xl 2xl:text-[70px] font-accent font-normal">
                                Arlene McCoy
                            </h4>
                    ...
                    <div className="relative h-[400px] md:h-[500px] 2xl:h-[560px] mx-2 md:mx-0">
                        ...
                        <div className="d2c_chef_quote" data-aos="fade-up">
                            <div className="rounded bg-primary p-4 shadow-[-4px_4px_8px_0_#3b3d32]">
                                <span className="text-3xl text-accent"><FaQuoteLeft /></span>
